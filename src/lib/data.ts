...
export const speakers: Speaker[] = [
  ...
  },
  {
    ...
    bio: 'Mrs. Mittal Patel is a social activist and founder of VSSM (Vicharta Samuday Samarthan Manch), working for the rights of nomadic and de-notified tribes. A recipient of the Nari Shakti Puraskar, she has spent years studying and supporting communities on the margins of society. Her work focuses on providing identity, education, and livelihood to those often forgotten by the mainstream.',
    image: '/speakers/mittal.jpeg',
    socials: { instagram: '#' }
  },
  {
    id: '7',
...
export const volunteers = [
  'Aayushi Pandey', 'Astha Raval', 'Atharv Bhamerkar', 'Atik Chavda', 'Aviral Mishra',
  'Ayushi Kharva', 'Chirag Sharma', 'Darsh Sharma', 'Devam Shah', 'Dhairya Manglani',
  'Dhanraj Prajapati', 'Dipak Parmar', 'Divyanshu Joshi', 'Dweep Gadkari', 'Harsh Shah',
  'Isha Singh', 'Jaitra Thaker', 'Jigar Dodiya', 'Kavy Talati', 'Ketan Prajapati',
  'Keval Vaghela', 'Kirtan Limbachiya', 'Mahesh Darji', 'Makwana svapnil', 'Muru Modhvadiya',
  'Neelabh Tripathi', 'Nijal Bilwal', 'Om Potdar', 'Pankti Joshi', 'Parth Parmar',
  'Riddhi Umaraniya', 'Sahil Saini', 'Sanjitsingh Kalotia', 'Sarthak Joshi', 'Siddhi Kulkarni',
  'Soumya Upadhyay', 'Tanmay Prasad', 'Unnati Maradia', 'Utkarsh Talaviya', 'Vipra Desai'
];
...
export const program: ProgramItem[] = [
  ...
  },
  {
    ...
    description: 'Mrs. Chetna Joshi Tiwari explores neuroscience of education',
    speaker: 'Mrs. Chetna Joshi Tiwari'
  },
  {
    id: '4',
    time: '11:15 AM',
    title: 'Energy for All',
    description: 'Mr. Upendra Tripathy on renewable energy innovation',
    speaker: 'Mr. Upendra Tripathy'
  },
  {
    id: '5',
    time: '12:00 PM',
  ...
  },
  {
    ...
    description: 'Mrs. Mittal Patel on cultural preservation',
    speaker: 'Mrs. Mittal Patel'
  },
  {
    id: '7',
    time: '2:30 PM',
