            ...
            <div className="glass-card p-12 md:p-20 text-center relative overflow-hidden">
                ...
                <div className="relative z-10">
                    ...
                    <motion.button
                        ...
                        whileTap={{ scale: 0.95 }}
                        className="bg-red-600 text-white font-bold py-4 px-10 rounded-full text-lg shadow-[0_0_30px_rgba(230,43,30,0.3)] hover:shadow-[0_0_50_rgba(230,43,30,0.5)] transition-all"
                    >
                        Register for Syntopia 2026
                    </motion.button>
